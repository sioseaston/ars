...
<div class="layout">
    ...
    <div class="main">
        <div class="container">
            ...
            <!-- HEADER -->
            <div class="header">
                <h1>🐾 About Animal Rescue System</h1>
            </div>
            ...
            <div class="grid" style="grid-template-columns: 1fr;">
                ...
                <div class="box">
                    <p>
                        ...
                        report missing or found domestic animals, report wildlife near homes or in critical condition, and support wildlife surrender cases. It connects the community
                ...
                <div class="box">
                    <h2>👨‍💻 Our Team</h2>
                    <p>
                        This system was developed as a thesis project to support local animal
                        rescue efforts and improve communication between the public and rescuers.
                    </p>
                </div>
                ...
                <div class="box">
                    <h2>📞 Contact Us</h2>
                    <p>Email: pwrcc.pawb@gmail.com</p>
                    <p>Phone: 0945 889 8099 / 0992 673 8491</p>
